...
# %load "PIAIC55985_Assignment2.py"
...
def function2():
    ...
    x =     np.arange(10, 36+1, dtype='float64').reshape((3,3,3))
...
def function14():
    ...
    ans = np.split(ary=arr,indices_or_sections=4)
...
def function17():
  ...
  return np.where((arr%3==0 and arr%5==0), "YES", "NO")
